// Archivo de pruebas para el generador de folios en JavaScript
const { generarSiguienteFolio, generarSiguienteNumeracion, incrementarLetras } = require('./GeneradorFolio');
...
async function probarGeneradorFolio() {
	console.log('\n=== Pruebas de generarSiguienteFolio ===');

	// Simulando una colección de folios en memoria
	const foliosExistentes = ['A00001', 'A00002', 'A00004', 'A00005'];
